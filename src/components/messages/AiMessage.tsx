...
export function AiMessage({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex w-full">
      <div className="max-w-xl md:max-w-2xl w-full flex gap-2 relative border group">
        ...
        <div className="bg-slate-100 relative p-4 rounded-2xl rounded-bl-lg shadow-md">
